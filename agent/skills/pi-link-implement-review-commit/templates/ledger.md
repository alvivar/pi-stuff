...
| Task / scope | Implement | Gate / coverage gaps | Review | Commit | Notes |
| --- | --- | --- | --- | --- | --- |
| <id> | <DISPATCHED / DONE / BLOCKED> | <results> | <verdict / pending> | <hash / pending> | <current state, context decision when useful> |
...
- Completion: <commits, required evidence, limitations, remaining findings>.
- Final summary: <posted / pending>.
- Ledger disposal: <pending until completion>.
